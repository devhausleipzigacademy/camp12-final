...
async function main() {
	...
	const user1 = await prisma.user.create({
		data: {
			...
			settings: {
				create: {
					friendsVisibility: VisibilityStatus.Private,
	...
	const user2 = await prisma.user.create({
		data: {
			...
			settings: {
				create: {
					friendsVisibility: VisibilityStatus.FriendsOnly,
					profileVisibility: VisibilityStatus.FriendsOnly,
				},
			},
		},
	});
	...
	const user3 = await prisma.user.create({
		data: {
			...
			settings: {
				create: {
					friendsVisibility: VisibilityStatus.Public,
